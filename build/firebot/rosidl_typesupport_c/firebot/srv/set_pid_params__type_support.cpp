...
static const _SetPIDParams_Request_type_support_symbol_names_t _SetPIDParams_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firebot, srv, SetPIDParams_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, firebot, srv, SetPIDParams_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, firebot, srv, SetPIDParams_Request)() {
  return &::firebot::srv::rosidl_typesupport_c::SetPIDParams_Request_message_type_support_handle;
}
...
static const _SetPIDParams_Response_type_support_symbol_names_t _SetPIDParams_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firebot, srv, SetPIDParams_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, firebot, srv, SetPIDParams_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, firebot, srv, SetPIDParams_Response)() {
  return &::firebot::srv::rosidl_typesupport_c::SetPIDParams_Response_message_type_support_handle;
}
...
static const _SetPIDParams_type_support_symbol_names_t _SetPIDParams_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firebot, srv, SetPIDParams)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, firebot, srv, SetPIDParams)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, firebot, srv, SetPIDParams)() {
  return &::firebot::srv::rosidl_typesupport_c::SetPIDParams_service_type_support_handle;
}
