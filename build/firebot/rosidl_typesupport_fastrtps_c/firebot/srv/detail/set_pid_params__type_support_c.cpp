...
#include "firebot/srv/detail/set_pid_params__rosidl_typesupport_fastrtps_c.h"
...
#include "firebot/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _SetPIDParams_Request__ros_msg_type = firebot__srv__SetPIDParams_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_firebot
size_t get_serialized_size_firebot__srv__SetPIDParams_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetPIDParams_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_firebot__srv__SetPIDParams_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_firebot
size_t max_serialized_size_firebot__srv__SetPIDParams_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = firebot__srv__SetPIDParams_Request;
    is_plain =
      (
...
static size_t _SetPIDParams_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_firebot__srv__SetPIDParams_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firebot, srv, SetPIDParams_Request)() {
...
using _SetPIDParams_Response__ros_msg_type = firebot__srv__SetPIDParams_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_firebot
size_t get_serialized_size_firebot__srv__SetPIDParams_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPIDParams_Response__ros_msg_type * ros_message = static_cast<const _SetPIDParams_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_firebot__srv__SetPIDParams_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_firebot
size_t max_serialized_size_firebot__srv__SetPIDParams_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = firebot__srv__SetPIDParams_Response;
    is_plain =
      (
...
static size_t _SetPIDParams_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_firebot__srv__SetPIDParams_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firebot, srv, SetPIDParams_Response)() {
...
// already included above
// #include "firebot/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "firebot/srv/set_pid_params.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, firebot, srv, SetPIDParams)() {
