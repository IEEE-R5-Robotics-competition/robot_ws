...
#include "firebot/msg/detail/encoder_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const firebot::msg::EncoderData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  firebot::msg::EncoderData & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = firebot::msg::EncoderData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firebot::msg::EncoderData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<firebot::msg::EncoderData *>(
    untyped_ros_message);
...
{
  return &firebot::msg::typesupport_fastrtps_cpp::_EncoderData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, firebot, msg, EncoderData)() {
  return &firebot::msg::typesupport_fastrtps_cpp::_EncoderData__handle;
}
