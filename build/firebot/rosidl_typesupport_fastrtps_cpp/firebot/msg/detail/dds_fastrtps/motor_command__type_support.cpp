...
#include "firebot/msg/detail/motor_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = firebot::msg::MotorCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firebot::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<firebot::msg::MotorCommand *>(
    untyped_ros_message);
...
{
  return &firebot::msg::typesupport_fastrtps_cpp::_MotorCommand__handle;
}
