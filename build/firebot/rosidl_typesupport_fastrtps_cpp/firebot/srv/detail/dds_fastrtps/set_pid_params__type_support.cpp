...
#include "firebot/srv/detail/set_pid_params__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = firebot::srv::SetPIDParams_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firebot::srv::SetPIDParams_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<firebot::srv::SetPIDParams_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_firebot
const rosidl_message_type_support_t *
get_message_type_support_handle<firebot::srv::SetPIDParams_Request>()
{
  return &firebot::srv::typesupport_fastrtps_cpp::_SetPIDParams_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = firebot::srv::SetPIDParams_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const firebot::srv::SetPIDParams_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<firebot::srv::SetPIDParams_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &firebot::srv::typesupport_fastrtps_cpp::_SetPIDParams_Response__handle;
}
...
{
  return &firebot::srv::typesupport_fastrtps_cpp::_SetPIDParams__handle;
}
