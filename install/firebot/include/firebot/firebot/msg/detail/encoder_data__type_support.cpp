...
{
  new (message_memory) firebot::msg::EncoderData(_init);
}

void EncoderData_fini_function(void * message_memory)
{
  auto typed_message = static_cast<firebot::msg::EncoderData *>(message_memory);
  typed_message->~EncoderData();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember EncoderData_message_member_array[1] = {
  {
    ...
    offsetof(firebot::msg::EncoderData, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EncoderData_message_members = {
  "firebot::msg",  // message namespace
  "EncoderData",  // message name
  1,  // number of fields
  sizeof(firebot::msg::EncoderData),
...
{
  return &::firebot::msg::rosidl_typesupport_introspection_cpp::EncoderData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, firebot, msg, EncoderData)() {
  return &::firebot::msg::rosidl_typesupport_introspection_cpp::EncoderData_message_type_support_handle;
}
