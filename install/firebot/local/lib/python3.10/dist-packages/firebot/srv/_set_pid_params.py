...
class Metaclass_SetPIDParams_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('firebot')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_SetPIDParams(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from firebot.srv import _set_pid_params
...
class SetPIDParams(metaclass=Metaclass_SetPIDParams):
    from firebot.srv._set_pid_params import SetPIDParams_Request as Request
    from firebot.srv._set_pid_params import SetPIDParams_Response as Response
